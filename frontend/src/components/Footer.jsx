...
export default function Footer() {
  return (
    <footer className="bg-canvas border-t border-borderCustom py-8 px-4 font-main">
      <div className="w-full max-w-[1200px] mx-auto flex flex-col sm:flex-row flex-wrap items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center justify-center sm:justify-end gap-6">
          <a
            ...
            className="text-[14px] text-mutedText hover:text-ink no-underline font-medium transition-colors duration-200 flex items-center gap-1.5"
          >
            {/* Github Icon */}
          ...
          <Link
            to="/privacy"
            className="text-[14px] text-mutedText hover:text-ink no-underline font-medium transition-colors duration-200"
          >
            Privacy Policy
          </Link>
